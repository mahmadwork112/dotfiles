...
Singleton {
    ...
    property QtObject defaultColors: QtObject {
        ...
        // Accent
        property color m3primary: "#7daea3"                 // blue
        property color m3onPrimary: "#1d2021"

        property color m3primaryContainer: "#2f3436"        // bg4
        property color m3onPrimaryContainer: "#d4be98"

        property color m3secondary: "#89b482"               // aqua
        property color m3onSecondary: "#1d2021"

        property color m3secondaryContainer: "#45403d"      // bg3
        property color m3onSecondaryContainer: "#d4be98"

        // Backgrounds
        property color m3background: "#1d2021"              // bg0
        property color m3onBackground: "#d4be98"

        property color m3surface: "#282828"                 // bg1

        property color m3surfaceContainerLow: "#262a2b"     // bg2
        property color m3surfaceContainer: "#2f3436"        // bg4
        property color m3surfaceContainerHigh: "#45403d"    // bg3
        property color m3surfaceContainerHighest: "#45403d"

        property color m3onSurface: "#d4be98"

        property color m3surfaceVariant: "#928374"          // grey1
        property color m3onSurfaceVariant: "#a89984"        // grey0

        property color m3inverseSurface: "#d4be98"
        property color m3inverseOnSurface: "#1d2021"

        property color m3outline: "#7c6f64"                 // grey2
        property color m3outlineVariant: "#928374"
        ...
        stdout: StdioCollector {
            ...
            onStreamFinished: {
                ...
                const normalized = JSON.stringify({
                    mode: mode,
                    palette: palette,
                    profile: caelestiaAccentProfile
                });
